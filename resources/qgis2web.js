...
map.getView().fit([504007.390511, 6868814.617890, 526214.891078, 6889886.507633], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Delivery Zones - Netherland</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (151 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This web map is created to identify service areas which are covered by a franchise chain. Thereby this tells you which location delivers to which area.';
            }
